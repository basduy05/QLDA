...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div x-data="{ activePopup: null }" class="fixed bottom-6 right-6 flex flex-col gap-4 z-50 items-end">
            ...
            <!-- AI Popup -->
            <div x-show="activePopup === 'ai'" x-transition.opacity.duration.300ms class="fixed bottom-24 right-6 w-[450px] h-[700px] max-w-[calc(100vw-3rem)] max-h-[calc(100vh-8rem)] bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col z-50" style="display: none;">
            ...
            <!-- Messenger Popup -->
            <div x-show="activePopup === 'messenger'" x-transition.opacity.duration.300ms class="fixed bottom-24 right-6 w-[800px] h-[700px] max-w-[calc(100vw-3rem)] max-h-[calc(100vh-8rem)] bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col z-50" style="display: none;">
