    ...
    <x-slot name="header">
        <div class="flex items-center justify-between gap-3">
            <div>
                ...
                <h2 class="text-3xl font-semibold text-slate-900">{{ __('AI Settings') }}</h2>
                <p class="text-sm text-slate-500 mt-1">{{ __('Configure Google AI Studio Gemini API for project assistant.') }}</p>
            </div>
